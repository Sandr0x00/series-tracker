...
.series {
	...
	position: relative;
	width: <?php echo $displayWidth; ?>px;
	overflow: hidden;
}
  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-header pull-left">
        <ul class="nav">
          <li>
            <a id="plus" class="btn btn-default" type="button">
      ...
      <div class="navbar-header pull-right">
        <ul class="nav">
          <li>
            <a id="refresh" href="javascript:refresh();" class="btn btn-default" type="button">
...
foreach ($serien as $zeile) {
    ...
    if (!startsWith($zeile, "#")) {
        ...
        // see series.js
        echo "<a class=\"series $class\" id=\"$titel_\"><img class=\"$class\" id=\"$titel_"."_pic\" style=\"margin-left:$margin;\" src=\"$imgLocation\" height=\"$realHeight" . "px\" width=\"$displayWidth" . "px\" alt=\"$titel\"/><span class=\"shadow\" id=\"$titel_" . "1\"><br>" . $serie['1'] . "</span></a>\n";
